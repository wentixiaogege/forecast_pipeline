...
def gen_plan_feas(plans_df):
    ...
    svd_enc = TruncatedSVD(n_components=36, n_iter=20, random_state=2019)
...
def gen_profile_feas(data):
    ...
    svd = TruncatedSVD(n_components=36, n_iter=20, random_state=2019)
...
def get_train_test_feas_data():
    ...
    data.to_csv('./featues.csv', index=False)
